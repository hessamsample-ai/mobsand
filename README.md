...
یک گردش‌کار گیت‌هاب که فایل‌ها را از هر لینک مستقیم انلود کرده، در صورت نیاز به تکه‌های 95 مگابایتی تقسیم می‌کند، و با دسته‌های 5 تایی در مخزن ذخیره می‌کند — ایده‌آل برای کاربران ایرانی بدون دسترسی به هاست‌های خارجی.
